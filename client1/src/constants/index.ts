...
const NODE_URL = (import.meta as any).env?.VITE_STARKNET_RPC || "https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_7/3S-9NEC4IdEbT_sx5zfRd";
export const provider = new RpcProvider({ nodeUrl: NODE_URL, specVersion: '0.7.1' });
